...
{else}
  <table class="gbDataTable"><tr>
	...
	{g->text text="The path you entered is not a valid directory or is not accessible."}
      ...
      <div class="giError">
	{g->text text="The path you entered does not contain valid ImageMagick binaries. Use the 'test' button to check where the error is."}
      </div>
      {/if}
