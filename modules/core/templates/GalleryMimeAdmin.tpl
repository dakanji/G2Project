...
<div class="gbBlock gcBackground1">
  <h2> {g->text text="Gallery Mime Maintenance"} </h2>
</div>
...
<div class="gbBlock"><h2 class="giSuccess">
  ...
  {if isset($status.mimeSaved)}
    {g->text text="Gallery mime entry saved successfully"}
  {/if}
  {if isset($status.deleted)}
    {g->text text="Gallery mime entry deleted"}
  {/if}
</h2></div>
{/if}
...
<div class="gbBlock gcBackground1">
  ...
  <input type="button" class="inputTypeButton" value="{g->text text="Add New Mime Type"}"
   onclick="document.location='{g->url arg1="view=core.SiteAdmin" arg2="subView=core.ItemMimeEdit"}'">
</div>
...
<div class="gbBlock">
  ...
  <tr class="{cycle values="gbEven,gbOdd"}">
	...
	&nbsp;
      ...
      <a href="{g->url arg1="view=core.SiteAdmin" arg2="subView=core.ItemMimeEdit"
       arg3="mimeType=`$mime`"}">
	<img src="{g->url href="modules/core/data/info16_1.gif"}"
	 width="16" height="16" alt="{g->text text="edit"}" title="{g->text text="edit"}">
      </a>
      &nbsp;
      <input type="image" src="{g->url href="modules/core/data/module-inactive.gif"}"
