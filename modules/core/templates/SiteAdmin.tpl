 ...
 *}
<form action="{g->url}" method="post" id="siteAdminForm" enctype="{$SiteAdmin.enctype|default:"application/x-www-form-urlencoded"}">
	<div>
		{g->hiddenFormVars}
		{if !empty($controller)}
				...
				<div id="gsSidebar" class="gcBorder1">
					<div class="gbBlock">
						...
						<li class="{g->linkId view=$choice.view.subView}">
							<a href="{g->url}/../lib/tools/phpunit/index.php">Test Suite</a>
						</li>
					</div>
					<div class="gbBlock">
