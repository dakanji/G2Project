...
{capture name="loginDescriptionDownload"}
    <div class="giDescription">
      {g->text text="In order to proceed with the password reset, we have to verify that you are who you claim.  The best way to be sure is to ask you to make a tiny change in the Gallery directory which will prove that you have the right permissions.  So, we are going to ask that you create a new text file called %s in your gallery2 directory. It must contain the following randomly generated characters:" arg1="<strong>authFile.txt</strong>"}
    </div>
    <h2>
    ...
    <div class="giDescription">
      ...
      {/capture}
      {g->text text="As a convenience to you, we have prepared a %scorrect version of authFile.txt%s for you.  Download that and copy it into your install directory and you are all set." arg1=$smarty.capture.downloadUrl arg2="</a>"}
     </div>
     <div class="giDescription">
       {g->text text="Once you have uploaded the file, click refresh to continue."}
     </div>
{/capture}
