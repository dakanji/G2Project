...
class NumberFormatter {
	 ...
	 * PHP's round() function, but there is an equivalent. Keys are rounding
	...
	public function formatCurrency($value, $currency) {
		...
		// there is a non-breaking space after the currency code (i.e. CRC 100), but not if the currency has a symbol (i.e. £100).
