...
if (!defined('_ADODB_LAYER')) {
	...
	if (!$ADODB_EXTENSION || ADODB_EXTENSION < 4.0) {
		...
		} elseif ($_adodb_ver > 4.299999) { // 4.3
			define('ADODB_PHPVER', 0x4300);
		} elseif ($_adodb_ver > 4.199999) { // 4.2
	...
	class ADOConnection {
		 ...
		 */
		public function outp($msg, $newline = true) {
		...
		public function xCacheFlush($sql = false, $inputarr = false) {
			global $ADODB_CACHE_DIR;
		 ...
		 */
		public function _gencachename($sql, $createdir, $memcache = false) {
			global $ADODB_CACHE_DIR;
			static $notSafeMode;
		...
		public function &GetActiveRecordsClass($class, $table, $whereOrderBy = false, $bindarr = false, $primkeyArr = false) {
	...
	class ADORecordSet extends ADODB_BASE_RS {
		...
		// Added by Ivan Oliva to implement recordset pagination
