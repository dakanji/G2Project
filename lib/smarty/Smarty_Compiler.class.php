...
class Smarty_Compiler extends Smarty {
	...
	public function _compile_file($resource_name, $source_content, &$compiled_content) {
		...
		$template_header .= '         compiled from ' . strtr(
	...
	public function _preg_callback($matches) {
	...
	public function _parse_var_props($val) {
		...
		if (preg_match('~^' . $this->_db_qstr_regexp . '(?:' . $this->_mod_regexp . '*)$~', $val)) {
			// double quoted text
		...
		if (preg_match('~^' . $this->_num_const_regexp . '(?:' . $this->_mod_regexp . '*)$~', $val)) {
			// numerical constant
