...
class SmartyPants {
	...
	// 1 => double only, 2 => double & single
	public $do_backticks = 0;

	// 1, 2, or 3 for the three modes described above
	public $do_dashes   = 0;
	public $do_ellipses = 0;
	public $do_stupefy  = 0;

	// should we translate &quot; entities into normal quotes?
	public $convert_quot = 0;
	...
	protected function educateBackticks($_) {
		...
		$_ = str_replace(
			array('``', "''"),
			array(
				$this->backtick_doublequote_open,
	...
	protected function educateSingleBackticks($_) {
		...
		$_ = str_replace(
			array('`', "'"),
			array(
				$this->backtick_singlequote_open,
