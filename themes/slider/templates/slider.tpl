...
<div id="imagearea" class="gcBackground1">
  {if $theme.params.enableImageMap}<img
     src="{g->theme url="images/arrow-left.gif"}" alt="" class="navGIF navGIFL"
...
<div id="image"></div>
  {if $theme.params.enableImageMap}<img
     src="{g->theme url="images/arrow-right.gif"}" alt="" class="navGIF navGIFR"
...
<div id="titlebar" class="gcBackground2 gcBorder2">
  <div id="tools_left">
    <img id="opts" src="{$theme.themeUrl}/images/tool.png" class="navPNG"
     onclick="options_onoff()" alt="{g->text text="Options"}" title="{g->text text="Options"}">
     <img id="slide_poz" src="{$theme.themeUrl}/images/poz.png" class="navPNG"
     onclick="slide_onoff()"
     alt="{g->text text="Pause Slideshow"}" title="{g->text text="Pause Slideshow"}">
     <img id="slide_fwd" src="{$theme.themeUrl}/images/fwd.png" class="navPNG"
     onclick="slide_onoff()"
     alt="{g->text text="Start Slideshow"}" title="{g->text text="Start Slideshow"}">
     <img id="slide_rev" src="{$theme.themeUrl}/images/rev.png" class="navPNG"
     onclick="slide_onoff()"
     alt="{g->text text="Start Slideshow"}" title="{g->text text="Start Slideshow"}">
     <img id="slide_rand" src="{$theme.themeUrl}/images/rand.png" class="navPNG"
     onclick="slide_onoff()"
     alt="{g->text text="Start Slideshow"}" title="{g->text text="Start Slideshow"}">
     </div>
  <div id="tools_right">
    <img id="full_size" src="{$theme.themeUrl}/images/full.png" class="navPNG"
     onclick="image_zoom(1)" alt="{g->text text="Full Size"}" title="{g->text text="Full Size"}">
     <img id="fit_size" src="{$theme.themeUrl}/images/fit.png" class="navPNG"
     onclick="image_zoom(0)" alt="{g->text text="Fit Size"}" title="{g->text text="Fit Size"}">
     <img id="prev_off" src="{$theme.themeUrl}/images/prev-off.png" class="navPNG"
     alt="{g->text text="No Previous Image"}" title="{g->text text="No Previous Image"}">
     <img id="prev_img" src="{$theme.themeUrl}/images/prev.png" class="navPNG"
     onclick="image_prev()"
     alt="{g->text text="Previous Image"}" title="{g->text text="Previous Image"}">
     <img id="next_off" src="{$theme.themeUrl}/images/next-off.png" class="navPNG"
     alt="{g->text text="No Next Image"}" title="{g->text text="No Next Image"}">
     <img id="next_img" src="{$theme.themeUrl}/images/next.png" class="navPNG"
